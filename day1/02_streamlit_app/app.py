...
st.write("app.pyの変更で利用者情報の入力欄を作成しました")
st.markdown("---")

# テキスト入力
st.subheader("あなたの名前や年齢、性別を入力してください")
...
st.write(f"あなたは{option}性の{age}歳なんですね！")
st.write("チャットをお楽しみください！")
st.markdown("---")
...
# --- フッターなど（任意） ---
st.sidebar.markdown("---")
st.sidebar.info("開発者: [susumu saito]")